    ...
    return (
        <div className=' max-w-6xl mx-auto rounded-md'>
            <div className="w-full grid grid-cols-1 md:grid-cols-4 grid-rows-8 md:grid-rows-2 gap-3">
                <div className="w-full aspect-[16/8] rounded-xl bg-white shadow-md border p-3 flex flex-col items-start justify-between">
                    <div className="w-full flex items-start justify-between">
                        <p className="font-semibold">Order</p>
                        <BoxIcon className='w-7 h-7 shrink-0' />
                    </div>
                    <p className="w-full text-5xl font-semibold">
                        201
                    </p>
